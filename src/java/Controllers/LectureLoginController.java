 ...
 * @author Alen morgen
 */
@WebServlet(name = "LectureLoginController", urlPatterns = {"/LectureLoginController"})
public class LectureLoginController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            pst = con.prepareStatement("SELECT * FROM lecture_table WHERE email=? AND password =?");
            ...
            if (rs.next()) {
                ...
                request.getRequestDispatcher("lectureLogin.jsp").forward(request, response);
            }

        } catch (SQLException ex) {
            Logger.getLogger(LectureLoginController.class.getName()).log(Level.SEVERE, null, ex);
